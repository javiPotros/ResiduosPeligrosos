...
public class FIniciarSesion extends javax.swing.JFrame {
    ...
    public FIniciarSesion(FNegocios fNegocios) {
        initComponents();
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (usuario != null) {
            ...
            switch (usuario.getTipo().toLowerCase()) {
                case "productora":
                    FPrincipalProductora fPrincipalProductora = new FPrincipalProductora(usuario, fNegocios);
                    fPrincipalProductora.setVisible(true);
                    this.dispose();
                    break;
                case "administrador":
                    FPrincipalAdmin fPrincipalAdmin = new FPrincipalAdmin(usuario, fNegocios);
                    fPrincipalAdmin.setVisible(true);
                    this.dispose();
                    break;
                case "transportadora":
                    FPrincipalTransportadora fPrincipalTransportadora = new FPrincipalTransportadora(usuario, fNegocios);
